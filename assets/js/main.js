...
goog.require("jayq.core");
main.core.layout = function layout(content) {
  var dom4905 = document.createElement("div");
  dom4905.setAttribute("id", "content");
  dom4905.appendChild(dommy.template.__GT_node_like.call(null, content));
  return dom4905
};
main.core.main = function main() {
  return jayq.core.replace.call(null, jayq.core.$.call(null, "#content"), main.core.layout.call(null, "more <br/> coming <br/> soon"))
};
